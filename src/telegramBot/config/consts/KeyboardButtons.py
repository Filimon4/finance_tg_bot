...
InlineKeyboardButtons = {
  ...
  "admin": [
    ...
    [
      InlineKeyboardButton(text="Обновить все валюты и курсы", callback_data="update_all_currency"),
      InlineKeyboardButton(text="Обновить валюты", callback_data="update_currency"),
      InlineKeyboardButton(text="Обновить курсы", callback_data="update_currency_rates")
    ],
    [
