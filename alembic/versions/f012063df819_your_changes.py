...
Revision ID: f012063df819
Revises: 
Create Date: 2025-04-03 01:48:49.729517
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=255), nullable=False),
    sa.Column('base_type', sa.Enum('INCOME', 'EXPENSIVE', name='transactiontype'), nullable=True),
    sa.Column('created_at', sa.TIMESTAMP(), nullable=True),
